...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="GraphGAN: Train or Generate on COIL-DEL")
    parser.add_argument("--mode", type=str, choices=["train", "generate"], default="train", help="运行模式：train 或 generate")
